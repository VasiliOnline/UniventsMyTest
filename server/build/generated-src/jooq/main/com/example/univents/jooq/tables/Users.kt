...
import com.example.univents.jooq.keys.USERS_EMAIL_UNIQUE
import com.example.univents.jooq.keys.USERS_PKEY
...
open class Users(
     ...
     */
    val PASSWORD: TableField<UsersRecord, String?> = createField(DSL.name("password"), SQLDataType.VARCHAR(64).nullable(false), this, "")
    ...
    override fun getUniqueKeys(): List<UniqueKey<UsersRecord>> = listOf(USERS_EMAIL_UNIQUE)
